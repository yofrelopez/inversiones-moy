// components/servicios/productos-peligrosos/ContentSection.tsx
"use client";
...
const beneficiosClave: Feature[] = [
  {
    set: "stroke7",
    icon: "pe-7s-note2", // authorization/permit icon
    text: "Transporte autorizado según D.S. 021-2008-MTC",
  },
  {
    set: "stroke7", 
    icon: "pe-7s-global", // international standards icon
    text: "Cumplimiento de directrices del Libro Naranja de la ONU",
  },
  {
    set: "trucking",
    icon: "\ue904", // certified personnel icon
    text: "Conductores y personal certificados en manipulación segura",
  },
  {
    set: "stroke7",
    icon: "pe-7s-shield", // safety protocols icon  
    text: "Protocolos sanitarios y de seguridad avalados",
  },
];
...
const serviciosIncluidos: Feature[] = [
  {
    set: "trucking",
    icon: "\ue908", // dangerous materials transport icon
    text: "Transporte de materiales y residuos peligrosos",
  },
  {
    set: "stroke7", 
    icon: "pe-7s-attention", // contingency plans icon
    text: "Planes de contingencia y gestión de riesgos",
  },
  {
    set: "trucking",
    icon: "\ue90c", // specialized equipment icon
    text: "Equipos de protección especializados",
  },
  {
    set: "transportation",
    icon: "f142", // monitoring and tracking icon
    text: "Monitoreo constante y trazabilidad total",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-lg p-8 shadow-sm">
              ...
              {/* Título principal */}
              <div className="mb-8">
                <h2 className="heading-2 mb-4">Seguridad y Cumplimiento en Cada Envío</h2>
                <div className="heading-underline"></div>
                
                <p className="text-lg text-gray-600 leading-relaxed">
                  Transporte especializado de mercancías peligrosas, con personal certificado y protocolos internacionales.
                </p>
              </div>
              ...
              <div className="prose prose-gray max-w-none">
                <div className="bg-gradient-to-r from-moyblue/5 to-yellow-400/5 p-6 rounded-xl border-l-4 border-moyblue mb-8">
                  <p className="text-lg leading-relaxed text-gray-700 mb-0">
                    El traslado de materiales peligrosos exige <strong className="text-moyblue">máxima seguridad y cumplimiento normativo</strong>. En Inversiones Moy contamos con experiencia, permisos y personal altamente capacitado para realizar operaciones confiables bajo estándares nacionales e internacionales.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 mb-8 hover:shadow-md transition-shadow duration-300">
                  <h3 className="text-2xl font-semibold text-moyblue mb-6 flex items-center gap-3">
                    <i className="pe-7s-medal text-moyblue text-[32px] not-italic" />
                    Beneficios clave:
                  </h3>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start gap-4">
                      <div className="shrink-0">
                        <i className="pe-7s-safe text-yellow-300 text-[40px] not-italic" />
                      </div>
                      <p className="text-lg leading-relaxed">
                        Confía en nuestro expertise para el manejo de <strong className="text-yellow-300">materiales críticos y peligrosos</strong>, garantizando seguridad total y cumplimiento normativo en cada operación.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <ul className="mt-6 space-y-4">
                  <li className="flex items-center gap-3">
                    ...
                    <Link href="/docs/brochure-materiales-peligrosos.pdf" className="text-gray-800 hover:text-gray-900">
                      Service Brochure
                    </Link>
                  </li>
                  <li className="flex items-center gap-3">
                    <i className="pe-7s-calculator text-[22px] text-gray-800 not-italic" />
                    <Link href="/docs/tarifas-materiales-peligrosos.pdf" className="text-gray-800 hover:text-gray-900">
                      Hazmat Rates
                    </Link>
                  </li>
                </ul>
