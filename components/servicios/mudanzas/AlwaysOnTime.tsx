    ...
    <section className="w-full py-16">
      <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        >
          ...
          {/* Texto extendido */}
          <motion.div variants={itemVariants} className="mt-8 max-w-3xl space-y-6 text-gray-600 text-sm leading-relaxed">
            <div>
          ...
          <motion.div variants={itemVariants} className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-x-16 gap-y-12">
